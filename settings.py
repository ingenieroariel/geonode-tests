# Django settings for GeoNode Test project.
...
TEST_RUNNER = 'geonode_tests.tests.runner.GeoNodeTestRunner'
...
#      '--stop',
      ...
      '--nocapture',
      '--with-coverage',
      '--cover-package=geonode,geonode_tests',
      '--cover-inclusive',
      '--cover-tests',
      '--detailed-errors',
      '--with-xunit',
...
import logging
for _module in ["geonode.maps.views", "geonode.maps.gs_helpers", "geonode.maps.utils"]:
